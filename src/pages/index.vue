  ...
  <div>
    <div class="flex h-screen">
      ...
      <div class="w-64 bg-white">
        ...
        <div class="py-2">
          ...
          <PerfectScrollbar class="ps">
            <ul class="menu-list">
              <li class="relative mx-2 rounded-md">
                <a
                  href="#"
              ...
              <li>
                ...
                <ul v-if="openSubMenu === 'profil'" class="ml-6">
                  <li>
              ...
              <li>
                ...
                <ul v-if="openSubMenu === 'rekod'" class="ml-6">
                  <li>
      ...
      <div class="flex-1 flex flex-col">
        ...
        <!-- Content Area -->
        <main class="flex-1 overflow-y-auto p-4 bg-blue-50">
          <!-- Page Header -->
          ...
          <div class="bg-white rounded-lg shadow overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <!-- Table body is empty in the screenshot -->
              </tbody>
            </table>
          </div>
        </main>
